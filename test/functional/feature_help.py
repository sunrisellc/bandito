...
"""Verify that starting bandito with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bandito with -h for help text")
        ...
        self.log.info("Start bandito with -version for version information")
        ...
        self.log.info("Start banditod with -fakearg to make sure it does not start")
