...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " bandito-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  bandito-tx [options] <hex-tx> [commands]  Update hex-encoded bandito transaction\n" +
            "or:     bandito-tx [options] -create [commands]   Create hex-encoded bandito transaction\n" +
            "\n";
