...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s banditocoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  banditocoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded banditocoin transaction") + "\n" +
              "  banditocoin-tx [options] -create [commands]   " + _("Create hex-encoded banditocoin transaction") + "\n" +
              "\n";
