...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s bandito-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bandito-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bandito transaction") + "\n" +
              "  bandito-tx [options] -create [commands]   " + _("Create hex-encoded bandito transaction") + "\n" +
              "\n";
