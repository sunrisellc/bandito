...
const char * const BITCOIN_CONF_FILENAME = "bandito.conf";
const char * const BITCOIN_PID_FILENAME = "bandito.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Bandito";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Bandito";
#else
    // Unix
    return pathRet / ".bandito";
#endif
#endif
}
