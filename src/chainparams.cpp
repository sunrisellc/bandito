...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlock(1641565110, 2026192554, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
//        assert(consensus.hashGenesisBlock == uint256S("02dda1728cd2f60ba39cd8bf9fceedc0488881849e7a0a844fb10762bce7a322"));
        assert(genesis.hashMerkleRoot == uint256S("3350346a2a7dafd343880436d8421a5cdb535b3d1b1536ba38ca369b38e4ed6f"));
        ...
        checkpointData = {
            {
                {0, uint256S("02dda1728cd2f60ba39cd8bf9fceedc0488881849e7a0a844fb10762bce7a322")},
            }
        };
