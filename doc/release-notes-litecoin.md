...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 ese per kB (0.00001 BNDT). This is to prepare for dropping the minimum transaction fee to 0.1 ese per kB (0.0001 BNDT) in the next release.
