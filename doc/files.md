...
* bandito.conf: contains configuration settings for banditod or bandito-qt
* banditod.pid: stores the process id of banditod while running
...
* debug.log: contains debug information and general logging generated by banditod or bandito-qt
