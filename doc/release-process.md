...
* Update manpages, see [gen-manpages.sh](https://github.com/sunrisellc/bandito/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/sunrisellc/gitian.sigs.ltc.git
    git clone https://github.com/sunrisellc/bandito-detached-sigs.git
    git clone https://github.com/devrandom/gitian-builder.git
    git clone https://github.com/sunrisellc/bandito.git
...
- Detached signatures will then be committed to the [bandito-detached-sigs](https://github.com/sunrisellc/bandito-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/sunrisellc/bandito/releases/new) with a link to the archived release notes.
