...
* Update manpages, see [gen-manpages.sh](https://github.com/banditocoin/bandito/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/banditocoin/gitian.sigs.ltc.git
    git clone https://github.com/banditocoin/bandito-detached-sigs.git
    git clone https://github.com/devrandom/gitian-builder.git
    git clone https://github.com/banditocoin/bandito.git
...
By default, Gitian will fetch source files as needed. To cache them ahead of time, make sure you have checked out the tag you want to build in bandito, then:
...
### Build and sign Bandito Core for Linux, Windows, and macOS:

    export GITIAN_THREADS=2
    export GITIAN_MEMORY=3000
    
    pushd ./gitian-builder
    ./bin/gbuild --num-make $GITIAN_THREADS --memory $GITIAN_MEMORY --commit bandito=v${VERSION} ../bandito/contrib/gitian-descriptors/gitian-linux.yml
    ...
    ./bin/gbuild --num-make $GITIAN_THREADS --memory $GITIAN_MEMORY --commit bandito=v${VERSION} ../bandito/contrib/gitian-descriptors/gitian-win.yml
    ...
    ./bin/gbuild --num-make $GITIAN_THREADS --memory $GITIAN_MEMORY --commit bandito=v${VERSION} ../bandito/contrib/gitian-descriptors/gitian-osx.yml
...
Build output expected:
  ...
  4. macOS unsigned installer and dist tarball (`bandito-${VERSION}-osx-unsigned.dmg`, `bandito-${VERSION}-osx64.tar.gz`)
  5. Gitian signatures (in `gitian.sigs.ltc/${VERSION}-<linux|{win,osx}-unsigned>/(your Gitian key)/`)

### Verify other gitian builders signatures to your own. (Optional)

Add other gitian builders keys to your gpg keyring, and/or refresh keys: See `../bandito/contrib/gitian-keys/README.md`.
...
Codesigner only: Sign the macOS binary:
    ...
    transfer bandito-osx-unsigned.tar.gz to macOS for signing
...
- Detached signatures will then be committed to the [bandito-detached-sigs](https://github.com/banditocoin/bandito-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
space *do not upload these to the www.banditocoin.com server, nor put them in the torrent*.
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the www.banditocoin.com server.

```
- Update www.banditocoin.com version

- Update other repositories and websites for new version

- Announce the release:

  - bandito-dev mailing list

  - blog.www.banditocoin.com blog post
  ...
  - Create a [new GitHub release](https://github.com/banditocoin/bandito/releases/new) with a link to the archived release notes.
