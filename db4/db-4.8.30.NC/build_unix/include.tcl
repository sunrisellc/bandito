...
set tclsh_path 
set tcllib .libs/libdb_tcl-4.8.so

set rpc_server localhost
set rpc_path .
set rpc_testdir $rpc_path/TESTDIR

set src_root /home/dev/banditocoin/db4/db-4.8.30.NC/dist/..
set test_path /home/dev/banditocoin/db4/db-4.8.30.NC/dist/../test
set je_root /home/dev/banditocoin/db4/db-4.8.30.NC/dist/../../je
